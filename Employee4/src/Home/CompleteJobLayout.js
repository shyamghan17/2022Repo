    ...
    return (
      <View>
        {this.props.featuredCompleteJobColor != "" ? (
          ...
          <ViewOverflow style={[styles.CompleteJobLayoutmainStyle, styles.Elevation]}>
            {this.props.featuredCompleteJobColor != "" ? (
              <View
                style={{
                  width: 0,
          ...
          <View style={[styles.section, {paddingRight:0}]}>
            <ViewOverflow style={[styles.CompleteJobLayoutmainStyle2, styles.Elevation]}>
              {this.props.featuredCompleteJobColor != "" ? (
                <View
                  style={{
                    width: 0,
              ...
              <View style={styles.CompleteJobLayoutshadow}>
                ...
                { this.props.Completejoblevel != '' &&
                  <View
                    style={styles.CompleteJobLayoutInfoArea}
                  >
                    <Text style={[styles.ParagraphTextStyle,{color: "#00cc8d",width: 13,textAlign:"center"}]}>
                      $
                    </Text>
                    <Text
                      style={[styles.ParagraphTextStyle, {paddingLeft:10}]}
