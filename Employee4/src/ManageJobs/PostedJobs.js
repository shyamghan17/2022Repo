            ...
            <View style={{  }}>
              {item.color != "" ? (
                <View style={[styles.section, styles.Elevation]}>
                  <View style={[styles.CompleteJobLayoutmainStyle, {overflow: 'hidden', marginRight: 0}]}>
                    <TouchableOpacity
                      onPress={() =>
                    ...
                    {item.delete_job_status == 'yes' &&
                      <TouchableOpacity 
                        onPress={() => this._deletePost(item.ID)}
                        activeOpacity={0.7}
                ...
                <View style={[styles.section, styles.Elevation]}>
                  <View style={[styles.CompleteJobLayoutmainStyle2, {overflow: 'hidden', marginRight: 0}]}>
                    <TouchableOpacity
                      onPress={() =>
                        this.props.navigation.navigate("ViewProposals", {
                          my_id: item.ID.toString(),
