...
class SelectedDocLayout extends Component {
  renderExpandor = () => {
    return (<Text>
      {CONSTANT.SelectedDocLayoutReadMore}
    </Text>);
  }
  renderCollapsar = () => {
    return (<Text>
      {CONSTANT.SelectedDocLayoutReadLess}
    </Text>);
  }
  render() {
    return (
      <TouchableOpacity elevation={5} style={styles.container}>
        <View style={{ padding: 10, backgroundColor: '#dddddd', marginLeft: 20, marginRight: 20, borderRadius: 10, marginVertical: 10 }}>
          <View style={{}}>
            {/* <TextTruncate
