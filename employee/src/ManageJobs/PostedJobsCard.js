    ...
    return (
      <View style={{ marginTop: 15 }}>
        {this.props.featuredCompleteJobColor != ""
          ? <View
              style={[styles.section, styles.Elevation, { paddingRight: 0 }]}
            >
              <View
                style={[
                  styles.CompleteJobLayoutmainStyle,
                  { overflow: "hidden" }
                ]}
              >
                <TouchableOpacity
                ...
                >
                  <View style={{ width: "70%" }}>
                    ...
                    />
                    <View
                      style={[styles.CompleteJobLayoutshadow, { width: "70%" }]}
                    >
                      <View>
                      ...
                      ? // <FlatList
                        ...
                        >
                          ...
                          >
                            <Text
                              style={[
                                styles.SectionHeadingTextStyles,
                                { color: CONSTANT.TextColorGreen, fontSize: 18 }
                              ]}
                            >
                              {this.props.count}
                            </Text>
                          ...
                          >
                            <Image
                              ...
                              source={{
                                uri: this.props.freelancerImages[0].url
                              }}
                            />
                            {this.props.freelancerImages.length >= 2 &&
                              <Image
                                ...
                                source={{
                                  uri: this.props.freelancerImages[1].url
                                }}
                              />}
