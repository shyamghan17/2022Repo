  ...
  render() {
    return (
      <View
        style={[
          styles.container,
          { backgroundColor: "#ffffff", overflow: "hidden", borderRadius: 5 }
        ]}
      >
        ...
        <View style={{ margin: 10 }}>
          ...
          >
            <Text style={[styles.OtherTextStyle, { marginRight: 5 }]}>
              {CONSTANT.HomeServiceStartingFrom}
            </Text>
            <Text
          ...
          <View style={{ flexDirection: "row", alignItems: "center" }}>
            ...
            <Text style={[styles.OtherTextStyle, { marginLeft: 10 }]}>
              {this.props.service_queue} {CONSTANT.HomeServiceinqueue}
            </Text>
          </View>
        </View>
      </View>
